...
### Magnitude of AOH changes following abandonment {.unnumbered}
...
See Fig. (histogram of )



Key conclusions:

(ref:caption-aoh-change-percent-by-trend) The distribution of changes in area of habitat (AOH) as a percent of site area, shown according to directional trend. Changes in AOH are calculated as the different in average AOH during the first and last 5 years of the time series.
...
These associations are not markedly different when assuming no recultivation took place ("potential abandonment" scenario).
...
(ref:caption-dw-stat) Durbin-Watson statistics for trends of AOH for Calculation 1, tracking AOH in abandoned croplands only.
...
(ref:caption-aoh-change-percent-by-site) The distribution of changes in area of habitat (AOH) as a percent of total area at each site. Changes in AOH are calculated as the different in average AOH during the first and last 5 years of the time series.
...
(ref:caption-p-gain-by-n-occ) Proportion of bird and mammal species with significant gains in AOH following cropland abandonment from 1987-2017, shown according to the number of suitable habitats listed by IUCN (i.e., level 1 habitats as classified by IUCN, excluding marine habitats, "Caves & Subterranean Habitats", "Introduced Vegetation," "Other," and "Unknown" classes).

```{r p-gain-by-n-occ, fig.cap = '(ref:caption-p-gain-by-n-occ)'}
