...
### Summary statement (tbd) {.unnumbered}
...
The lone exception were birds in Iraq (our site with the lowest species richness; Fig. \@ref(fig:richness-by-site)), where only `r aoh_stats_main$wl_iraq` times as many birds gained habitat on average as lost
...
This pattern also held, though a bit more weakly, across individual IUCN status (Fig. \@ref(fig:aoh-by-iucn)), which showed that species in higher risk categories gained relatively more habitat.
Though relatively few small-ranged birds and mammals were affected by abandonment at our sites (3 and 6 species, respectively), we also found that nearly all small-ranged species gained habitat as a result of abandonment (with the exception of one small-ranged bird: the Iraq babbler, *Argya altirostris*; see Fig. \@ref(fig:aoh-by-range)).
...
Thoughts:
- the balance shifts towards losers in both scenarios 2 and 3 for birds and mammals
- Compared to only the habitat provided by abandonment, we see that there are many more species with losing trends in AOH.
- there are more losers than winners for birds.
- mammals have about equal numbers of winners and losers in both scenarios.  still have more winners than losers overall in scenario 2, but there are more losing mammals than winning more consistent losers than consistent winners
- at both sites, the number of species with no trend or contrasting trends across sites increase (Opposites), and the number of loser species did not reach a majority \@ref(fig:aoh-overall-stacked). 

At individual sites:
- These trends again vary by site, but in general, the number of losing species increased across all sites when incorporating habitat loss that occurred prior to cultivation (Scenario 2; Fig. \@ref(fig:aoh-iucn-by-site-combo-max-abn)).
- When looking across the entire landscape at each site, 
- These trends were much weaker for mammals than for birds. At some of the sites with the clearest increases in losing bird species between Scenarios 1, 2, and 3 (e.g., `r paste0(long_labels[c(1,8, 10)], collapse = "; ")`), the number of mammal species that gained habitat overall remained higher than the number of species that lost habitat (Figs. \@ref(fig:aoh-by-site-max-abn) and \@ref(fig:aoh-by-site-full)).

Potential vs. observed:
- When considering our scenario of potential abandonment for AOH scenarios 2 and 3, we find that balance again flips in favor of winner species (Fig. \@ref(fig:aoh-overall), Fig. \@ref(fig:aoh-overall-stacked)).
- 
...
When placing the habitat changes resulting from cropland abandonment into a wider context that incorporates land cover changes that occurred prior to cultivation (Scenario 2) or across the entire landscape of each site (Scenario 3), we find that the balance of winners to losers becomes much less favorable (Fig. \@ref(fig:aoh-overall)).
In these two scenarios, more bird species lost habitat than gained habitat ()
...
Threatened species: as well as across AOH scenarios (Fig. \@ref(fig:aoh-by-iucn-lumped).

Fig. 4. Overall, side by side.
...
knitr::include_graphics(path = paste0(p_plots, "aoh/aoh_overall_w_site_combo_crop_abn_potential_iucn",
                                      aoh_run_date,".pdf"))
```
...
knitr::include_graphics(path = paste0(p_plots, "aoh/aoh_overall_w_site_combo_full_potential_iucn",
                                      aoh_run_date,".pdf"))
```
