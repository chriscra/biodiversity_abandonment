...
## P1: Abandonment intro

Amidst continued cropland expansion, hundreds of hectares of agricultural lands have been abandoned around the world since 1950 as a result of socioeconomic and demographic changes, political upheaval, and changing agricultural technologies [@ReyBenayas2007; @Li2017; @Potapov2022; @Chazdon2020].
While agricultural expansion and associated habitat loss remains the foremost threat to biodiversity [@Tilman2017], conservation scientists increasingly look to former agricultural lands for opportunities for restore ecosystems [@Navarro2012], sequester carbon [@Griscom2017; @Yand2020], and recover biodiversity [@Chazdon2020; @Xie2019; @Baumann2020] with minimal opportunity costs. 
As people continue to move from rural areas into cities and agriculture is pushed to become more efficient, many hope this trend of abandonment may continue, making such opportunities even more salient in the future [@Sanderson2018; @Rudel2020; @Taylor2021].
...
In some cases, abandonment may not provide enough time for substantial gains in carbon or biodiversity if former fields are recleared and recultivated, as recent evidence has shown is more common than previously thought for both secondary forests throughout the Neotropics [@Reid2018b; @Nunes2020; @Smith2020; @Sloan2022] and abandoned agricultural lands elsewhere [@Crawford2022; @Dara2018; @Smaliychuk2016].
...
Given that biodiversity is not equally distributed around the world, and that individual species have unique habitat and biophysical requirements, spatial and temporal variation in abandonment may play a substantial role in determining outcomes for biodiversity.
...
This controversy has perhaps been most prominent in Europe, where substantial amounts of conservation attention has been afforded to "farmland biodiversity:" species of conservation concern that are often dependent on open-habitats and low-intensity farmland, as a result of Europe's long history of cultivation, the loss of natural disturbance regimes, and cultural preferences [@Batary2015; @Fischer2014].
In the context of what could be lost, abandonment is sometimes viewed as a threat to biodiversity [@Queiroz2014], despite the potential for gains in other types of species. 
Variety within the natural world is one of the primary factors motivating conservation, and it follows that different species may respond differently to different types of alnd use change [@Sirami2008; @Finch2019].

However, from a conservation perspective, 
...
## P2: implications for biodiversity, controversy



For example, many European conservationists are concerned with what abandonment will mean for grassland and open habitat adapted species, usually referred to as “farmland biodiversity” [@VanderZanden2018]. @Queiroz2014 identified the importance of how conservationists frame the issue – from the perspective of the farmland biodiversity that could be lost (the “pre-abandonment focus”), or from the perspective of the historical habitat biodiversity that could be regained (the “post-abandonment focus”) – on whether they view abandoned as a threat or an opportunity for conservation."

## P3: what previous studies have lacked {-}

Despite a large number of studies investigating the recovery of biodiversity in abandoned agricultural land over time (typically species richness and abundance), these studies have been constrained in the spatial and temporal scale, and... [e.g., @Sirami2008; @Uchida2014]. 

Few studies have used this information to assess the biodiversity implications of abandonment at a landscape scale by connecting maps of abandonment to data for individual species.
...
For example, @Meyfroidt2016 simply use distance to protected areas as a proxy for biodiversity value, and @Henry2019 use only coarse measures of species richness and CI biodiversity hotspots.
...
A large portion of recent research on farmland abandonment has been focused on Europe [e.g., @Verburg2009], where ecologists and conservation scientists have long argued about whether, on net, abandonment is likely to benefit or harm biodiversity [@Queiroz2014]. 
...
Given that the effect of agricultural land use change is species-dependent [@Finch2019]
...
With a better understanding of the timing, persistence, and trajectories of abandoned agricultural land, researchers are now also better equipped to ask questions about its environmental implications, including how biodiversity is likely to be affected by abandonment. 
...
While individual studies can be detailed and extremely important for understanding changes to specific communities, they lack spatial and temporal coverage, and may not be able to cover as many species.

## P5: Questions, approach {.unnumbered}
...
Here, we combine range maps and habitat preferences for 2023 species of birds and mammals with an annual land cover time series to calculate changes in area of habitat [AOH, @Brooks2019] resulting from cropland abandonment at 11 sites from 1987 through 2017. 
...
In other words, `r aoh_stats_main$wl_prop_bird_site_sp` times as many bird and `r aoh_stats_main$wl_prop_mam_site_sp` times as many mammal species gained habitat, on average, than lost habitat.^[*Note:* these numbers include an individual trend for each species at each site. When looking overall trends for each species, proportions of winners to losers actually increases (to `r aoh_stats_main$wl_prop_bird_sp`x and `r aoh_stats_main$wl_prop_mam_sp`x for birds and mammals respectively for consistent winners and losers, and `r aoh_stats_main$wl_prop_bird_sp_w_weak` and `r aoh_stats_main$wl_prop_mam_sp_w_weak` when including "weak" species trends.]
