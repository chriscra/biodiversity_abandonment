...
This resulted in the exclusion of 187 species of birds, and 33 species of mammals.
...
When considering species trends overall, species with the same trend at each site were classified as such. 
...
When reporting magnitudes of AOH changes, we rely on two primary measures for each species at each site: 1) the overall change in AOH measured as a percent of site area ($100*(AOH_{end} - AOH_{start})/sitearea$, Figs. \@ref(fig:aoh-change-percent-by-trend) and \@ref(fig:aoh-change-percent-by-site)) and 2) the relative change in AOH measured as the ratio of final AOH to starting AOH, natural log transformed ($ln(AOH_{end} / AOH_{start})$, Fig \@ref(fig:log-ratio-aoh-change-by-site)).
...
We fit three linear models using species traits to predict 1) AOH trend (binary, gain or loss), 2) AOH change (% of site area), and 3) ratio AOH change (natural log transformed).
...
In addition to our primary model, we also report the results of models that exclude the two artificial terrestrial habitats, arable land and urban land (Tables \@ref(tab:traits-mod3-table)).
...
When excluding arable land and urban land suitability as predictors in our models, a range of other predictors become statistically significant, including habitat breadth, vertebrate class, and trophic level. 
