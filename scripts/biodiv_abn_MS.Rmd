...
For both vertebrate classes, the number of species with no trend or contrasting trends across sites ("Opposites") increased, and the number of loser species did not reach a majority (Fig. \@ref(fig:aoh-overall-stacked-w-pot)).
...
aoh_ms_tmp_trends %>%
  ...
  filter(aoh_type == "crop_abn_iucn") %>%
  pivot_wider(id_cols = c(site, aoh_type, vert_class, total_sp), 
