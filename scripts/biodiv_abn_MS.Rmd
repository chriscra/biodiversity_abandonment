...
The ratio of winners to losers varied among sites, but was always greater than one (Fig. \@ref(fig:aoh-by-site-crop-abn-prop), Table \@ref(tab:aoh-stats-by-site)), except for birds in Iraq (the site with the lowest species richness; Fig. \@ref(fig:richness-by-site)), where `r 100*(1-aoh_stats_main$wl_iraq)`% more species lost than gained habitat (Figs. \@ref(fig:aoh-by-site-crop-abn-prop), \@ref(fig:aoh-by-site-crop-abn)).
...
When considering the net habitat change after incorporating these processes, the ratio of winners to losers became much less favorable (Fig. \@ref(fig:aoh-overall)): about equal numbers of mammal species experienced habitat gains as experienced losses, and more bird species experienced habitat losses than those with gains (Table \@ref(tab:main-aoh-stats-table), Fig. \@ref(fig:aoh-overall-w-pot)).
...
Our multi-continental results echo the heterogeneous species responses shown in prior studies [@Koshida2018; @VanderZanden2017; @Daskalova2023; @Sirami2008; @Regos2016; @Queiroz2014], but provide a more generally positive assessment of abandonment: using consistent data and methodologies across our diverse sites, we show that more species benefited from abandonment than suffered from it in 10 of our 11 sites.
From a conservation perspective, these findings are encouraging, especially given that most threatened and small-ranged species, which are typically of greatest conservation concern, experienced gains in habitat due to cropland abandonment (though not significantly more so than non-threatened or large-ranged species; Figs. \@ref(fig:aoh-iucn-by-site-crop-abn), \@ref(fig:aoh-by-range)), despite conservation related concerns about the loss of agricultural land [@Wright2012].

Our finding of overall positive outcomes of abandonment contrasts with much of the existing literature on biodiversity and abandonment.
...
Our sites represented nine different biomes with different abandonment histories, species communities, species richness, and distributions of habitats (Fig. \@ref(fig:site-biomes), Table \@ref(tab:site-info-table)) [@Yin2020].
...
We note that Mato Grosso experienced the least cropland abandonment of any site and thus remained dominated by habitat loss (like much of the tropics [@Potapov2022]), which led to relatively small gains in AOH for individual species (one or two orders of magnitude smaller than in other sites, whether measured in absolute area or percent of site extent; Fig. \@ref(fig:aoh-sp-obs-crop-abn)) and the greatest share of species with losing trends when accounting for land-cover changes throughout the site (Fig. \@ref(fig:aoh-by-site-stacked)).
...
The negative responses to abandonment observed in some of our sites (e.g., in our Iraqi site, or Europe and Japan, as reported in the literature) may underscore regional patterns that are not adequately captured by our limited number of study sites.
...
This should be explored at a broader range of sites to ensure we have not missed any regional patterns.
...
Abandoned cropland can become suitable habitat for species associated with natural ecosystems, but regeneration may take many decades to achieve conditions whereby species richness or community composition is comparable to those of an intact ecosystem [@Acevedo-Charry2019; @Isbell2019; @Nerlekar2020; @Crouzeilles2017].
Moreover, each site has a unique distribution of habitat ages, which would affect the amount of habitat available to species with different age requirements (Fig. \@ref(fig:habitat-age-profile)).
We manually excluded species that require habitats older than 30 years (the length of our study period).
However, if post-abandonment successional habitats are protected from recultivation, species that require old-growth habitats will benefit eventually from abandonment, while species characteristic of earlier successional stages are likely to decline at those sites and establish in more recently abandoned land.
...
These factors as well as differences in dispersal ability among bird and mammal species will affect which species actually occupy and persist at a given abandoned site.
...
Our analysis is built on species range maps refined to Area of Habitat [@Brooks2019] maps to address errors of commission that commonly affect such maps [@DiMarco2017].
This approach relies heavily on a map of IUCN Level 2 habitat types [@Jung2020a], which is itself subject to uncertainty (72 ± 15% accuracy), and our maps of cropland abandonment have some inherent uncertainty as well [@Yin2020].
Our results need to be interpreted with that uncertainty in mind. 
We expected some errors of commission to be present across all habitat types, and thus also present in our estimates of both habitat loss and habitat gain.
However, because the main results of our analysis are based on the relative magnitudes of habitat gains and losses of individual species and across different species, some level of systematic but unbiased errors of commission should not affect our broad results. 
Habitat suitability models or species distribution models provide alternative methods for reducing commission errors, but these require the availability of species occurrence data, which vary substantially in quantity and quality across species and are subject to a range of complex methodological decisions that substantially affect outcomes [@Muscatello2021].
...
We analyzed changes in landscape configuration at our sites over time and found that while abandonment increased grassland and forest area overall, those land cover types became less aggregated over time, while cropland became more aggregated (though these trends were only statistically significant at half of our sites; see SI, Fig. \@ref(fig:frag-heatmap)).
...
They do, however, represent a mix of environmental, climatic, economic, and sociopolitical settings, in which abandonment is driven by a range of major drivers (Table S2 [@Yin2020]). 
...
In order to unlock the conservation potential of abandoned croplands, policymakers will need to create incentives and community initiatives that both prevent the recultivation of abandoned croplands and sustain and enhance habitat gains, while stopping further losses of natural and semi-natural ecosystems.
...
Such abandonment is not captured in our data [@Yin2020; @Crawford2022], so we focus on the abandonment of croplands exclusively.
...
We calculated three common metrics of landscape configuration to assess whether cropland abandonment led to more, larger, and less fragmented habitats: 1) Did land cover patches become more aggregated in the landscape? 2) Did land cover patches get larger over time? 3) Were land cover patches subject to less fragmentation over time?
