...
```{r update-coded-w-mammals}
habitat_age_req_2022_06_17_CC$mature_forest_obl %>% unique() %>% sort()
habitat_age_req_2022_06_17_CC %>%
  filter(is.na(mature_forest_obl))
# habitat_age_req_coded_final <- 
#   read_csv(file = paste0(p_derived, "habitat_age_req/", "habitat_age_req_coded.csv"))


# save
habitat_age_req_2022_06_17_CC %>%
  write_csv(file = paste0(p_derived, "habitat_age_req/", "habitat_age_req_coded_final.csv"))
```
