...
gg_aoh_example_sp <-
  aoh %>%
    filter(
      site %in% site_df$site[site_index],
      # binomial == sp_name,
      binomial %in% c("Sturnella magna", "Dryobates pubescens"),
      vert_class == "bird",
      aoh_type %in% aoh_types[c(6, 3, 1)],
      # !(vert_class == "bird" & mature_forest_obl > 0.5),
      passage_type == "exclude_passage"
...
ggsave(plot = gg_aoh_example_sp,
       filename = paste0(p_output, "plots/methods/", "aoh_ex_downy_woodpecker_meadowlark", 
                         ".pdf"),
