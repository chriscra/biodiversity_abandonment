...
aoh_change_df_tmp_plots %>%
  ...
  geom_vline(data = aoh_change_df_tmp_plots %>% 
                 filter(site != "mato_grosso") %>%
...
ggsave(gg_aoh_sp_obs_wisc_crop_plus3,
       filename = paste0(p_output, "plots/aoh/", "wisconsin_example_sp_trajectories_highlight",  aoh_run_date,
                         ".pdf"),
       width = 4.5, height = 3.5, units = "in")
```
...
lapply(c(1, 5, 10, 15), function(window_size_) {
  ...
  filename = paste0(p_output, "plots/aoh/effect_size/", 
                    "hist_aoh_change_as_prop_site_area_obs_by_site_", 
                    window_size_, ".pdf"),
  width = 7, height = 8.5, units = "in")
})
...
lapply(c(1, 5, 10, 15), function(window_size_) {
  ...
  aoh_start_end_l_tmp_plots %>% 
    filter(window_size == window_size_) %>%
    ggplot() + 
    geom_histogram(aes(x = abs_change_as_prop_site_area, fill = trend, group = trend), 
  ...
  filename = paste0(p_output, "plots/aoh/effect_size/", 
                    "hist_aoh_change_as_prop_site_area_obs_by_trend_", 
                    window_size_, ".pdf"),
