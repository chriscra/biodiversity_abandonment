...
This document houses code to load, manipulate, and model Area of Habitat (AOH) data produced on Princeton's High Performance Computing (HPC) Clusters (see "cluster/aoh.R").
