...
predicts.path <- "/Volumes/GoogleDrive/My Drive/data/Bd/PREDICTS/database.rds"


# --------------------------------------------------------------- #
# Read in the PREDICTS data
# --------------------------------------------------------------- #
predicts <- ReadPREDICTS(path = "/Volumes/GoogleDrive/My Drive/data/Bd/PREDICTS/database.rds")
